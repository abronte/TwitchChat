...
# to solve this without manual intervention, we fork the main loop 
# and kill the fork after every so often. this does produce zombie 
# procs, but the zombies dont take up any resources
loop do
  pid = fork { start_bot }
